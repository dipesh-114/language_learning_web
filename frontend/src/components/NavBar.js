  ...
  return (
    <Box sx={{ flexGrow: 1, mb: 2 }}>
      <AppBar position="static" color="primary" elevation={3}>
        <Toolbar>
          <IconButton size="large" edge="start" color="inherit" sx={{ mr: 1, display: { xs: "none", sm: "inline-flex" } }}>
            <MenuIcon />
          </IconButton>
          ...
          <Button color="inherit" component={Link} to="/vocabulary">Vocabulary</Button>
          <Button color="inherit" component={Link} to="/flashcard">Flashcards</Button>
